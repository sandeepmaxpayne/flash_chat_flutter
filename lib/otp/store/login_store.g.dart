...
mixin _$LoginStore on LoginStoreBase, Store {
  ...
  final _$isAlreaduAuthenticatedAsyncAction =
      AsyncAction('LoginStoreBase.isAlreaduAuthenticated');

  @override
  Future<bool> isAlreaduAuthenticated() {
    return _$isAlreaduAuthenticatedAsyncAction
        .run(() => super.isAlreaduAuthenticated());
  }
